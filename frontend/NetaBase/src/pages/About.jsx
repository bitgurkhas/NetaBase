          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-gray-950 rounded-xl p-6 border border-gray-800 hover:border-purple-600 transition-all duration-300">
              ...
              <p className="text-gray-400 leading-relaxed">
                ...
                illustrative purposes only. The views
                expressed are those of the public contributors and do not
                necessarily reflect the views of any affiliated organizations.
              </p>
            </div>
