    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.CharField(
                blank=True, help_text="Current location or constituency", max_length=255
            ),
        ),
        migrations.AlterField(
            model_name="politician",
        ...
        migrations.AlterField(
            ...
            name="comment",
            field=models.TextField(
                blank=True, help_text="Optional comment about the rating", null=True
            ),
        ),
        migrations.AlterField(
            model_name="rating",
        ...
        migrations.AddIndex(
            model_name="initiatives",
            index=models.Index(
                fields=["politician", "-created_at"],
                name="politicians_politic_8ccfb8_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="politician",
        ...
        migrations.AddIndex(
            model_name="politician",
            index=models.Index(
                fields=["is_active", "party"], name="politicians_is_acti_c32ed0_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="promises",
            index=models.Index(
                fields=["politician", "status"], name="politicians_politic_d013da_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="promises",
            index=models.Index(
                fields=["-created_at"], name="politicians_created_495980_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="rating",
            index=models.Index(
                fields=["politician", "-created_at"],
                name="politicians_politic_ae7f00_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="rating",
            index=models.Index(
                fields=["user", "-created_at"], name="politicians_user_id_e869ca_idx"
            ),
        ),
    ]
